...
public class words extends AppCompatActivity {
    ...
    //insert text
        ...
        db.insert("0","One of the most <adjective> characters in fiction is named\n" +
        ...
        db.insert("1","I wannabe a <job> when I grow up.\n" +
                "Just like my dad.\n" +
                "Life is <adjective> like that!\n");

        db.insert("2","Our American universities offer students many <adjective>\n" +
        ...
        db.insert("3","<Male-Name> has announced that his <adjective>\n" +
        ...
        db.insert("4","Here's how you dance the Monstrosity. Stand with your feet together.\n" +
